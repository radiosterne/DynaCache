...
namespace DynaCache
{
    ...
    public sealed class CacheableMethodAttribute : Attribute
    {
        ...
        {
            this.CacheSeconds = (int)configuration.CacheDurations[namedCacheDuration].Duration.TotalSeconds;
        }
        ...
        {
            this.CacheSeconds = (int)duration.TotalSeconds;
        }
